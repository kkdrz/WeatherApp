...
public interface WeatherService {
	...
	@Fluent
	WeatherService getAllCitiesWeathers(JsonArray citiesIds, Handler<AsyncResult<String>> resultHandler);
	
	@Fluent
	WeatherService getCityWeather(String cityId, Handler<AsyncResult<String>> resultHandler);
